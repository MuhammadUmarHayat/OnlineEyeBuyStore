<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Test_AddItems.aspx.cs" Inherits="EyeBuyStore.Test_AddItems" %>
...
&nbsp;|<asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="~/AddItems.aspx">Add Item</asp:HyperLink>
                        |<asp:HyperLink ID="HyperLink8" runat="server" NavigateUrl="~/AddHelpingMaterial.aspx">Add Helping material</asp:HyperLink>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierManagement.aspx.cs" Inherits="EyeBuyStore.SupplierManagement" %>
            ...
            <table class="auto-style1">
                <tr>
                    <td class="auto-style2" colspan="3">
                        ...
                        <strong>Supplier Pannel: Supply Management</strong>
         </h1>
                    </td>
                </tr>
                <tr>
...
&nbsp; |<asp:HyperLink ID="HyperLink5" runat="server" NavigateUrl="~/LogOut.aspx">Log Out</asp:HyperLink>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <br />
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EyStoreFinalDBConnectionString %>" SelectCommand="SELECT DISTINCT [itemId], [title], [category], [unitPrice], [quantity], [ManDate], [ExpiryDate], [Remarks] FROM [Items] WHERE ([userid] = @userid)" DeleteCommand="delete from items where itemid=@itemid" UpdateCommand="update Items set [title]=@title, [category]=@category, [unitPrice]=@unitPrice, [quantity]=@quantity, [Remarks]=@Remarks where itemid=@itemid">
                            <SelectParameters>
